      ...
      <div className="relative mx-auto max-w-6xl px-4 py-24">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 text-slate-700 text-lg">
            I secure systems, hunt vulnerabilities, and build resilient defenses. Explore skills, projects, and the impact I can bring to your organization.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a href="#contact" className="inline-flex items-center justify-center rounded-lg border border-slate-300 bg-white px-5 py-3 text-slate-900 font-medium hover:bg-slate-50">
              Contact Me
            </a>
          </div>
        </div>
